        ...
        <div className="fixed inset-0 z-50 overflow-y-auto bg-[var(--clinical-background)]">
          <header className="sticky top-0 z-10 flex flex-wrap items-center gap-3 border-b border-[var(--clinical-border)] bg-[var(--clinical-background)] px-4 py-3">
            <div className="flex-1">
              <h2 className="text-lg font-bold">Рубец после КС / ниша / CSP</h2>
              <p className="text-xs text-[var(--clinical-foreground-muted)]">
                Сагиттальный и фронтальный срезы, RMT, ниша, плодное яйцо относительно рубца.
              </p>
            </div>
            <Button type="button" variant="ghost" onClick={() => setScarOpen(false)}>
              Закрыть
            </Button>
          </header>
                  ...
                  return {
                    ...
                    scar_visualization: {
                      ...
                      payload: {
                        ...
                        gestationalSacDistanceToScarMm: state.gestationalSacDistanceToScarMm,
                        gestationalSacDistanceToInternalOsMm: state.gestationalSacDistanceToInternalOsMm,
                        bladderSerosaDistanceMm: state.bladderSerosaDistanceMm,
                        scarPregnancyRelation: state.scarPregnancyRelation,
                        emptyUterineCavity: state.emptyUterineCavity,
                        emptyCervicalCanal: state.emptyCervicalCanal,
                        sacEmbeddedInScar: state.sacEmbeddedInScar,
                        thinMyometriumBetweenSacAndBladder: state.thinMyometriumBetweenSacAndBladder,
                        vascularityAroundSac: state.vascularityAroundSac,
                      },
                    },
                  };
                });
