        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-slate-200">
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              ). Фактический регион инстанса смотрите в Supabase Dashboard → Project Settings →
              Infrastructure. В шаблонах окружения встречается pooler{" "}
              <span className="font-mono text-xs">eu-central-1</span> — при продакшене с ПДн РФ
              подтвердите локализацию или оформите поручение обработчику по 152-ФЗ. Объектное хранилище по
              умолчанию ориентировано на <span className="font-mono text-xs">ru-central1</span>, если не
              задано иное.
            </p>
            <p>
