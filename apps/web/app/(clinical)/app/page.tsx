...
const tiles = [
  ...
  {
    title: "Рубец / CSP",
    description: "Сагиттальный и фронтальный срезы: ниша/истмоцеле, RMT, беременность в рубце.",
    href: "/scar-niche",
    icon: Shield,
    badge: "КС",
    accentBar: "bg-gradient-to-r from-slate-700 to-rose-500",
  },
  {
      ...
      <div className="mx-auto max-w-6xl space-y-10">
        ...
        <section className="sonogyn-glass-card sonogyn-enter sonogyn-enter-delay-1 flex flex-wrap items-center gap-3 rounded-2xl p-4 sm:gap-4 sm:p-5">
          ...
          {[
            ...
            { href: "/scar-niche", label: "Рубец / CSP" },
