    ...
    <div className="px-4 py-10 lg:px-10">
      <div className="mx-auto max-w-5xl space-y-8">
        <header className="space-y-2">
          ...
          <Link href="/library" className="text-sm font-medium text-[var(--clinical-primary)] underline">
            ← Библиотека
          </Link>
          <Link href="/library/my-courses" className="ml-4 text-sm font-medium text-[var(--clinical-primary)] underline">
            Мои курсы
          </Link>
        </header>
        <CourseCatalogClient />
