...
export const RL = {
  ...
  aiChat: preset("RATE_LIMIT_AI_CHAT", 30, "RATE_LIMIT_AI_CHAT_WINDOW_SEC", 3600),
  aiTutor: preset("RATE_LIMIT_AI_TUTOR", 40, "RATE_LIMIT_AI_TUTOR_WINDOW_SEC", 60),
  evidenceBookmarks: preset("RATE_LIMIT_EVIDENCE_BOOKMARKS", 60, "RATE_LIMIT_EVIDENCE_BOOKMARKS_WINDOW_SEC", 60),
  examAttempts: preset("RATE_LIMIT_EXAM_ATTEMPTS", 120, "RATE_LIMIT_EXAM_ATTEMPTS_WINDOW_SEC", 60),
  ...
  profileExport: preset("RATE_LIMIT_PROFILE_EXPORT", 10, "RATE_LIMIT_PROFILE_EXPORT_WINDOW_SEC", 300),
  accountDelete: preset("RATE_LIMIT_ACCOUNT_DELETE", 3, "RATE_LIMIT_ACCOUNT_DELETE_WINDOW_SEC", 3600),
