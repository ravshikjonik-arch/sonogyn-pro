...
export { INVALID_CREDENTIALS_MSG, PASSWORD_RESET_GENERIC_MSG, SIGN_UP_GENERIC_MSG, RESEND_CONFIRMATION_MSG, EMAIL_NOT_CONFIRMED_MSG, PHONE_OTP_SENT_MSG, PHONE_OTP_DELAY_HINT } from "./safe-auth-messages";
