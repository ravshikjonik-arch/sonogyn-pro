...
const CLASSIFICATIONS: Omit<ClassificationHit, "score">[] = [
  ...
  { id: "tirads-3", system: "TI-RADS", label: "TI-RADS 3", subtitle: "Щитовидная · умеренно подозр.", href: "/tools/calc/rads/ti-rads" },
  { id: "tirads-4", system: "TI-RADS", label: "TI-RADS 4", subtitle: "Щитовидная · подозрительно", href: "/tools/calc/rads/ti-rads" },
