...
function buildMotivation(
  ...
  if (current === "guest") {
    return {
      headline: "Кабинет открыт без регистрации",
      subline: "Считайте и смотрите справочники сразу. Войдите позже — чтобы сохранить кейсы и пациентов.",
  ...
  if (current === "student") {
    return {
      headline: "Шаг 2 — заполните профиль ординатора",
      subline: "Укажите ФИО и специализацию — откроется следующий шаг карьерной лестницы.",
