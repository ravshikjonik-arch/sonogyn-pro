...
export const BIOMETRY_DISCLAIMER =
  "Калькуляторы — справочные примеры (ISUOG). Перед клиническими решениями верифицируйте нормы на локальной популяции. SonoGyn Pro использует формулы Hadlock и справочные перцентили — см. конкретный калькулятор.";
