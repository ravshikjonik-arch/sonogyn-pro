...
const RAW_NAVIGATION_CONFIG: NavigationItem[] = [
  ...
  },
  {
    ...
    description: "8 глав + модуль «Цитология · скрининг»: Bethesda, HPV, ASCCP, кейсы, AI + 25 вопросов.",
    icon: "BookOpen",
    badge: "8+25",
    isPro: false,
    order: 580,
  ...
  },
  {
    ...
    title: "O-RADS US",
    description: "O-RADS US v2022 + IOTA 2026 — калькулятор, картинки и расчет по тексту.",
    icon: "CircleDot",
    badge: "O-RADS",
    isPro: false,
    order: 710,
  },
  {
    ...
    domain: "rads",
    category: "rads-classifications",
    title: "МЖ · BI-RADS (УЗИ + ММГ)",
    description: "Отдельные блоки УЗИ и маммографии молочных желёз + комбо для врачей.",
    icon: "ScanLine",
    badge: "BI-RADS",
    isPro: false,
    order: 720,
  ...
  {
    id: "report.thyroid-tirads",
    slug: "thyroid-tirads-report",
    domain: "rads",
    category: "rads-protocols",
    title: "Протокол TI-RADS",
    description: "Щитовидная · ACR TI-RADS — описание, категория, ТАБ.",
    icon: "FileText",
    badge: "SRE",
    isPro: false,
    order: 781,
  ...
  {
    id: "report.obstetric-biometry",
    slug: "obstetric-biometry-report",
    domain: "obstetrics",
    category: "ob-protocols",
    title: "Протокол биометрии",
    description: "Акушерское УЗИ — срок, биометрия, плацента.",
    icon: "FileText",
    badge: "SRE",
    isPro: false,
    order: 782,
  ...
  },
  {
    ...
    description: "MUSA · IETA · IOTA · IDEA — гинекологические консенсусы.",
    icon: "BookMarked",
    badge: null,
    isPro: false,
    order: 950,
  ...
  // —— education (1000+) ——
  {
    ...
    description: "Клинический модуль FMF: малый срок и I скрининг (без внешних курсов).",
    icon: "GraduationCap",
    badge: "FMF",
    isPro: false,
    order: 1000,
